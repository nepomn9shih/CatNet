import { ActionType, DispatchType, ThunkType, UsersType } from "./../types/types";
...
//подписка на юзера
export const followThunkCreator = (userId: number): ThunkType => async (dispatch: DispatchType) => {
