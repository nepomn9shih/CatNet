...
const Post = ({ message, likeCount = 0}) => {
  ...
  return (
    <div className="list-group list-group-horizontal mb-2 row">
      <div className="list-group-item bg-dark postAvatar col-2 col-md-1">
      <img
        className="w-100"
      ...
      <div className="list-group-item bg-dark d-flex justify-content-center align-items-center like col-2 col-md-1">
